...
?>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li class="active"><a href="doctor-search.php">Services</a></li>
    ...
    <section id="services" class="services">
      ...
      <h2 class="mb-2">Cari Tenaga Kesehatan Sesuai Kebutuhan Anda!!!</h2>
      <p class="mb-4">Pilih dari ribuan Tenaga Kesehatan berpengalaman di Klinik terbaik di Indonesia</p>
      </div>
      ...
      <div class="bg-white pt-4 pl-5 pr-5 pb-4 rounded shadow" style="margin-top: 20px;">
        ...
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
          ...
          <p style="margin-top: 20px; color: grey; margin-bottom: 0;">ex. Dokter Umum</p>
      </div>
      ...
      if(isset($_POST['search'])) 
      {
        ...
        ?>
              ...
              <div class='section-title'>
                ...
                <h3>Cari Jadwal <span>Tenaga Kesehatan</span></h3>
                <p>Memberikan pelayanan terbaik, aman, bermutu tinggi dan inovatif.</p>
              </div>
          ...
          ?>
            ...
            <div class='member'>
              ...
              <div class='member-img'>
                <img src='assets/img/team/nakes.png' class='img-fluid' alt=''>
                <div class='social'>
            ...
            <?php
              ...
              echo "<p> Bidang: " . $rows['spesialisasi'] . "</p>";
