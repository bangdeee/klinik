    ...
    <div class="container d-flex align-items-center">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li class="active"><a href="buat-janji.php">Services</a></li>
        ...
        <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="" data-aos-delay="100">
            <div class="member">
              ...
              <?php
                ...
                echo "<p>Bidang: " . $row['spesialisasi'] . "</p>";
                            ...
                            <div class="card-body" style="outline: none;">
                                ...
                                <?php
                                    if (!isset($_SESSION["idUser"])) {
                                        echo "<a href='login.php' style='color: red; class='login'>Harap login terlebih dahulu</a>";
                                    } else {
                                    $row = mysqli_fetch_assoc($result);
                                ?>
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-12 mb-0">Keluhan-Vitamin</label>
