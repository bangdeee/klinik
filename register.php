...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <form action="includes/register.inc.php" method="post">
      ...
      <input type="password" id="password" class="fadeIn third" name="password" placeholder="password *minimal 6 karakter">
      <input type="password" id="repeatpassword" class="fadeIn third" name="repeatpassword" placeholder="repeat password">
      <input type="submit" class="fadeIn fourth" href="login.php" value="Register" name="submit">
    </form>
