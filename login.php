...
<head>
    ...
    <!--<link rel="icon" type="image/png" sizes="16x16" href="../assets/images/med.png"> -->
...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <div class="fadeIn first">
      <h2>Login</h2>
      <br><center><p>Klinik PMB Ani Dwi Astuti <a href='https://stokcoding.com/' title='StokCoding.com' target='_blank'>.</a></p></center>
    ...
    <form action="includes/login.inc.php" method="post">
      ...
      <input type="submit" class="fadeIn fourth" href="index.php" value="Log In" name="submit">
    </form>
