                ...
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <a class="navbar-brand" href="index.html">
                        ...
                        <span class="logo-text">
                            <!-- dark Logo text -->
                            <img src="../assets/images/klinik.png" alt="homepage" class="dark-logo" />
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <ul class="navbar-nav mr-auto mt-md-0 ">
                        ...
                        <li class="nav-item hidden-sm-down">
                            ...
                            <h4>Welcome Admin | Klinik Praktek Mandiri Bidan Ani Dwi Astuti </h4>                            </div>
                        </li>
                    </ul>
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="doctors-page.php" aria-expanded="false">
                                <i class="mr-3 fa fa-user" aria-hidden="true"></i><span class="hide-menu">Workers</span></a>
                        </li>
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">Workers</h3>
            ...
            <div class="container-fluid">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="../../includes/doctors.inc.php" class="form-horizontal form-material" method="post">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-12 mb-0">Field</label>
                                        <div class="col-md-12">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Workers Lists</h4>
                                <h6 class="card-subtitle">Click delete to delete Workers list</h6>
                                <div class="table-responsive">
                                    <table class="table user-table no-wrap">
                                        <thead>
                                            <tr>
                                                <th class="border-top-0">id_workers</th>
