        ...
        <div class="row">
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
              ...
              <p class="description">Klinik Praktek Mandiri Bidan Ani Dwi Astuti memiliki lebih dari 500 dokter umum, 2.200 spesialis, 
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box" data-aos="fade-up" data-aos-delay="400">
              ...
              <p class="description">Klinik yang progresif dan inovatif yang telah menjadi 
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 content d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="100">
            ...
            Temukan fasilitas dan layanan pemeriksaan terbaik untuk Anda di Klinik Praktek Mandiri Bidan Ani Dwi Astuti.</p>
            <ul>
              <li>-  Laboratotium Kebidanan (ANC,INC,PNC)</li>
              <li>-  Imunisasi Dasar</li>
              <li>-  Keluarga Berencana</li>
              <li>-  IVA Test</li>
              <li>-  Rawat Inap</li>
              <li>-  Hecting (Jahit Luka)</li>
              <li>-  Medical Check Up</li>
              <li>-  Injeksi Vitamin</li>
              <li>-  Khitan (Sunat)</li>
              <li>-  Baby Care</li>
            </ul>
    ...
    <section id="services" class="services">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          ...
          <p>Mengutamakan pelayanan yang bersifat personal dan memungkinkan Anda untuk memilih paket pemeriksaan sesuai riwayat kesehatan dan kebutuhan Anda.</p>
        </div>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box">
              ...
              <h4><a href="doctor-search.php">Cari Tenaga Kesehatan</a></h4>
              <p>Mengutamakan pelayanan yang bersifat personal dan memungkinkan Anda untuk memilih paket pemeriksaan sesuai riwayat kesehatan dan kebutuhan Anda</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box">
              ...
              <h4><a href="checkup.php">Check Up</a></h4>
              <p>Mengutamakan pelayanan yang bersifat personal dan memungkinkan Anda untuk memilih paket pemeriksaan sesuai riwayat kesehatan dan kebutuhan Anda</p>
            </div>
          </div>
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          <div class="col-lg-6">
            <div class="info-box mb-4">
              <i class="bx bx-map"></i>
              <h3>Our Address</h3>
              <p>Perumahan Taman Alamanda 2 Blok EF No. 4</p>
            </div>
          </div>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-3 col-md-6 footer-contact">
        <h3>Klinik Praktek Mandiri Bidan Ani Dwi Astuti<span>.</span></h3>
        <p>
          Perumahan Taman Alamanda 2 Blok EF No. 4<br>
          Mustikasari, Kec. Mustika Jaya, Kota Bekasi<br>
          Indonesia <br><br>
      ...
      <div class="col-lg-3 col-md-6 footer-links">
        <h4>Our Services</h4>
        <ul>
          <li><i class="bx bx-chevron-right"></i> <a href="#">Cari Tenaga Kesehatan</a></li>
...
<div class="container py-4">
  ...
  <div class="credits">
    ...
    Designed by <a href="">@iiniakuaa</a>
  </div>
</div>
</footer><!-- End Footer -->
